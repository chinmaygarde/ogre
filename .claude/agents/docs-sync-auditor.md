...
- This is the Ogre project: a sandbox for exploring ONNX Runtime and authoring a Vulkan Execution Provider.
...
You have a persistent Persistent Agent Memory directory at `/Users/saturn/VersionControlled/ogre/.claude/agent-memory/docs-sync-auditor/`. Its contents persist across conversations.
